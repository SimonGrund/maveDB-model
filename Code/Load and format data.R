...
clin_data = fread(clin_path)#The depletion score reported here is the number of replicates where the variant was depleted relative to the corresponding control siRNA replicate.
